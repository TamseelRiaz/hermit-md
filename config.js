...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || 'SNAPE-MD',
    ...
    BOT_INFO: process.env.BOT_INFO || 'SNAPE;SNAPE-MD;923142212383;https://telegra.ph/file/9a860ecce874aff14bab3.jpg',

    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'SNAPE;SNAPE-MD;https://telegra.ph/file/9a860ecce874aff14bab3.jpg' : process.env.AUDIO_DATA,

    STICKER_DATA: process.env.STICKER_DATA === undefined ? 'SNAPE;SNAPE-MD' : process.env.STICKER_DATA,
